...
export const SearchInput: React.FC<Props> = ({ className }) => {
  ...
  // TODO: change <any> to <Product[]> when api is ready
  const [products, setProducts] = React.useState<{ id: number; name: string; imageUrl: string }[]>([]);
          ...
          <div
            ...
            {products.map((product) => (
              <Link
                ...
                <Image className="rounded-sm h-8 w-8" src={product.imageUrl} alt={product.name} />
